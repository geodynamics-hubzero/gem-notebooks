...
def read_statistics(fname):
    """
    This function reads a statistics file generated by the CIG software ASPECT
    and returns a pandas table, where names are taken from the statistics file.

    Parameters
    ----------
    fname : str
        The name of the statistics file to read.
 
    Returns
    -------
    values : a pandas DataFrame that stores the data from the statistics file.
    """
...
def read_vtu_file (file_name):
    """
    This function takes an input .vtu file name from a structured or
